...
class Cub200Dataset(torch.utils.data.Dataset):
  ...
  def gather(self):
      split_path = os.path.join(self.root_path, 'train_test_split.txt')
      img_path = os.path.join(self.root_path, 'images.txt')
      label_path = os.path.join(self.root_path, 'image_class_labels.txt')
      ...
      self.paths = [os.path.join(self.root_path, 'images', p) for p in img_df['path'].to_numpy()]
